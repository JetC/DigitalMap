// MapWingDoc.cpp : implementation of the CMapWingDoc class
//
...
IMPLEMENT_DYNCREATE(CMapWingDoc, CDocument)

BEGIN_MESSAGE_MAP(CMapWingDoc, CDocument)
	//{{AFX_MSG_MAP(CMapWingDoc)
...
/////////////////////////////////////////////////////////////////////////////
// CMapWingDoc construction/destruction

CMapWingDoc::CMapWingDoc()
{
...
BOOL CMapWingDoc::OnNewDocument()
{
...
/////////////////////////////////////////////////////////////////////////////
// CMapWingDoc serialization

void CMapWingDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
/////////////////////////////////////////////////////////////////////////////
// CMapWingDoc diagnostics

#ifdef _DEBUG
void CMapWingDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CMapWingDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CMapWingDoc commands

void CMapWingDoc::OnFileOpen() 
{
	CFileDialog dlg(TRUE,"*.wing",NULL,OFN_HIDEREADONLY|OFN_ALLOWMULTISELECT|OFN_OVERWRITEPROMPT,"数据文件(*.wing)|*.wing|任意文件(*.*)|*.*||",NULL);
	if(dlg.DoModal() == IDOK)
	{
	    if(NULL!=map1)
		{
...
void CMapWingDoc::ReadWingData(CString FileName)
{
	FILE *fp;
...
void CMapWingDoc::OnChangeformat() 
{
	...
	if (dlg.DoModal()==IDOK)
	{
		...
		ChangeDxfToWing(m_strSouceFile,m_strOutFile);
		AfxMessageBox("转换成功！");		
	}
}
void CMapWingDoc::ChangeDxfToWing(CString s_FileName,CString o_FileName)
{
	FILE *fp1,*fp2;
	//打开转换源文件与自定义文件
...
void CMapWingDoc::OnLayerselect() 
{
	// TODO: Add your command handler code here
	CLayerChooseDlg dlg;
	dlg.DoModal();
...
void CMapWingDoc::BmpSave(CString FileName)
{
	CViewBitmap bmp;
	CMapWingView *pView=(CMapWingView*)(((CMainFrame*)AfxGetMainWnd())->GetActiveView());
	CRect rect;
...
void CMapWingDoc::OnFilesave() 
{
	...
	{
		m_strBmpPath=dlg.GetPathName();
		WriteWingData(m_strBmpPath);
	}
	
}

void CMapWingDoc::WriteWingData(CString FileName)
{
	FILE *fp;
